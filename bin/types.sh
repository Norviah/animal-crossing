...
./node_modules/quicktype/dist/cli/index.js "$data/Events.json"                    --just-types -t Event        -o "$location/Event.ts"
./node_modules/quicktype/dist/cli/index.js "$data/IDs.json"                       --just-types -t ID           -o "$location/ID.ts"
...
./node_modules/quicktype/dist/cli/index.js $(eval echo "$data/*Hemisphere.json")  --just-types -t Hemisphere   -o "$location/Hemisphere.ts"
